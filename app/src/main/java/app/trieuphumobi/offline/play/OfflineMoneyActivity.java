 ...
 */
public class OfflineMoneyActivity extends Activity {
...
//        listTGM = seria_dataQuestion2.getData();
        ...
        mp_luatchoi = MediaPlayer.create(OfflineMoneyActivity.this, R.raw.luatchoi);
        mp_luatchoi.start();
        mp_luatchoi.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                mp_luatchoi.release();
                mp_luatchoi = new MediaPlayer();
                mp_luatchoi = MediaPlayer.create(OfflineMoneyActivity.this, R.raw.ready);
                mp_luatchoi.start();
                mp_luatchoi.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
                        mp_luatchoi.release();
                        mp_luatchoi = new MediaPlayer();
                        mp_luatchoi = MediaPlayer.create(OfflineMoneyActivity.this, R.raw.gofind);
                        mp_luatchoi.start();
                        mp_luatchoi.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            @Override
                            public void onCompletion(MediaPlayer mp) {
                                if (skip == true) {
                                    Intent intent = new Intent(OfflineMoneyActivity.this, OfflinePlayActivity.class);
