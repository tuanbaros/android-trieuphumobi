package app.trieuphumobi.offline.play;
...
import app.trieuphumobi.EndGameActivity;
import app.trieuphumobi.R;
import app.trieuphumobi.offline.getdata.DataOfflineModel;
 ...
 */
public class OfflinePlayActivity extends Activity {

    DataOfflineModel mDataOfflineModel = DataOfflineModel.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listQuestion = mDataOfflineModel.getmOfflineQuestion();
        listTrogiupDoicauhoi = mDataOfflineModel.getmOfflineQuestionForUserChange();
...
// create media finish time question
        ...
        mp_out_of_time = MediaPlayer.create(OfflinePlayActivity.this, R.raw.out_of_time);
...
// create countdowntimer for a question
        cdt = new CustomCountDownTimer(total, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intent = new Intent(OfflinePlayActivity.this, EndGameActivity.class);
...
// create media
        ...
        mp_soundtrack = MediaPlayer.create(OfflinePlayActivity.this, R.raw.moc1);
        mp_soundtrack.start();
        ...
        Rlayout_answerA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (choseAnser == 0) {
                    ...
                    checkPos = 1;
                    dialogAnswer = new Dialog(OfflinePlayActivity.this, R.style.DialogCustomTheme);
...
//                dialogAnswer.getWindow().setBackgroundDrawable(new ColorDrawable(Color.argb(0, 255, 255, 255)));
                    ...
                    Rlayout_D.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            mp_answer = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ans_a);
                            mp_answer.start();
...
//                dialogAnswer.getWindow().setBackgroundDrawable(new ColorDrawable(Color.argb(25, 25, 255, 255)));
                    ...
                    Rlayout_D.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Rlayout_answerC.setBackgroundResource(R.drawable.img_answerc);
                            Rlayout_answerD.setBackgroundResource(R.drawable.img_answerd);
                            mp_answer = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ans_b);
                            mp_answer.start();
                            if (!blPasue) {
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
...
//                dialogAnswer.getWindow().setBackgroundDrawable(new ColorDrawable(Color.argb(0, 0, 255, 255)));
                    ...
                    Rlayout_D.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Rlayout_answerC.setBackgroundResource(R.drawable.img_answercselected);
                            Rlayout_answerD.setBackgroundResource(R.drawable.img_answerd);
                            mp_answer = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ans_c);
                            mp_answer.start();
                            if (!blPasue) {
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
                ...
                if (choseAnser == 0) {
                    ...
                    Rlayout_D.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Rlayout_answerC.setBackgroundResource(R.drawable.img_answerc);
                            Rlayout_answerD.setBackgroundResource(R.drawable.img_answerdselected);
                            mp_answer = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ans_d);
                            mp_answer.start();
                            if (!blPasue) {
                                Handler handler = new Handler();
                                handler.postDelayed(new Runnable() {
            ...
            public void onClick(View v) {
                if (choseAnser == 0) {
                    ...
                    if (check == true) {
                        ...
                        Toast.makeText(OfflinePlayActivity.this, "Bạn chỉ được sử dụng trợ giúp đổi câu hỏi một lần!", Toast.LENGTH_LONG).show();
                }
                ...
                if (choseAnser == 0) {
                    ...
                    if (check1 == true) {
                        ...
                        Rlayout_D.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                dialogAnswer.cancel();
                                mp_trogiup = MediaPlayer.create(OfflinePlayActivity.this, R.raw.sound5050);
                                mp_trogiup.start();
...
//                                check1 = true;
                        ...
                        Toast.makeText(OfflinePlayActivity.this, "Bạn chỉ được sử dụng trợ giúp 50 50 một lần!", Toast.LENGTH_LONG).show();
                }
                ...
                if (choseAnser == 0) {
                    ...
                    if (check2 == true) {
                        ...
                        Rlayout_D.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                dialogAnswer.cancel();
                                mp_trogiup = MediaPlayer.create(OfflinePlayActivity.this, R.raw.call);
                                mp_trogiup.start();
                                goiDien(answer_true);
                        ...
                        Toast.makeText(OfflinePlayActivity.this, "Bạn chỉ được sử dụng trợ giúp gọi điện cho người thân một lần!", Toast.LENGTH_LONG).show();
                }
                    ...
                    if (check3 == true) {
                        ...
                        Rlayout_D.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                mp_trogiup = MediaPlayer.create(OfflinePlayActivity.this, R.raw.khan_gia);
                                mp_trogiup.start();
                                mp_trogiup.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                    @Override
                                    public void onCompletion(MediaPlayer mp) {
                        ...
                        Toast.makeText(OfflinePlayActivity.this, "Bạn chỉ được sử dụng trợ giúp của khán giả một lần!", Toast.LENGTH_LONG).show();
                }
...
//        Rlayout_answerD.startAnimation( animHide );
    ...
    public void showAnsTrue(int ans_true) {
        ...
        switch (ans_true) {
            case 1:
                mp_answer_true = MediaPlayer.create(OfflinePlayActivity.this, R.raw.true_a);
                ...
                break;
            case 2:
                mp_answer_true = MediaPlayer.create(OfflinePlayActivity.this, R.raw.true_b);
                mp_answer_true.start();
                ...
                break;
            case 3:
                mp_answer_true = MediaPlayer.create(OfflinePlayActivity.this, R.raw.true_c);
                mp_answer_true.start();
                ...
                break;
            case 4:
                mp_answer_true = MediaPlayer.create(OfflinePlayActivity.this, R.raw.true_d);
                mp_answer_true.start();
    ...
    public void showAnsFalse(int ans_true) {
        ...
        switch (ans_true) {
            case 1:
                mp_lose = MediaPlayer.create(OfflinePlayActivity.this, R.raw.lose_a);
                mp_lose.start();
                Rlayout_answerA.setBackgroundResource(R.drawable.true_a);
                AnimationDrawable pro = (AnimationDrawable) Rlayout_answerA.getBackground();
                pro.start();
                break;
            case 2:
                mp_lose = MediaPlayer.create(OfflinePlayActivity.this, R.raw.lose_b);
                mp_lose.start();
                Rlayout_answerB.setBackgroundResource(R.drawable.true_b);
                AnimationDrawable pro1 = (AnimationDrawable) Rlayout_answerB.getBackground();
                pro1.start();
                break;
            case 3:
                mp_lose = MediaPlayer.create(OfflinePlayActivity.this, R.raw.lose_c);
                mp_lose.start();
                Rlayout_answerC.setBackgroundResource(R.drawable.true_c);
                AnimationDrawable pro2 = (AnimationDrawable) Rlayout_answerC.getBackground();
                pro2.start();
                break;
            case 4:
                mp_lose = MediaPlayer.create(OfflinePlayActivity.this, R.raw.lose_d);
                mp_lose.start();
                Rlayout_answerD.setBackgroundResource(R.drawable.true_d);
                AnimationDrawable pro3 = (AnimationDrawable) Rlayout_answerD.getBackground();
                pro3.start();
    ...
    public void playSoundQues(int position) {
        switch (position) {
            case 0:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques01);
                mp_question.start();
                break;
            case 1:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques02);
                mp_question.start();
                break;
            case 2:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques03);
                mp_question.start();
                break;
            case 3:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques04);
                mp_question.start();
                break;
            case 4:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques05);
                mp_question.start();
                break;
            case 5:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques06);
                mp_question.start();
                break;
            case 6:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques07);
                mp_question.start();
                break;
            case 7:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques08);
                mp_question.start();
                break;
            case 8:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques09);
                mp_question.start();
                break;
            case 9:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques10);
                mp_question.start();
                break;
            case 10:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques11);
                mp_question.start();
                break;
            case 11:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques12);
                mp_question.start();
                break;
            case 12:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques13);
                mp_question.start();
                break;
            case 13:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques14);
                mp_question.start();
                break;
            case 14:
                mp_question = MediaPlayer.create(OfflinePlayActivity.this, R.raw.ques15);
                mp_question.start();
                break;
    ...
    public void play_Audio() {
        ...
        mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                ...
                mp_question_audio = new MediaPlayer();
                mp_question_audio = MediaPlayer.create(OfflinePlayActivity.this, R.raw.dapan_a);
                mp_question_audio.start();
                mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                    @Override
                    public void onCompletion(MediaPlayer mp) {
...
//                        mp_question_audio.start();
                        mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                            ...
                            public void onCompletion(MediaPlayer mp) {
                                mp_question_audio.release();
                                mp_question_audio = new MediaPlayer();
                                mp_question_audio = MediaPlayer.create(OfflinePlayActivity.this, R.raw.dapan_b);
                                mp_question_audio.start();
                                mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                    @Override
                                    public void onCompletion(MediaPlayer mp) {
...
//                                        mp_question_audio.start();
                                        mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                            ...
                                            public void onCompletion(MediaPlayer mp) {
                                                mp_question_audio.release();
                                                mp_question_audio = new MediaPlayer();
                                                mp_question_audio = MediaPlayer.create(OfflinePlayActivity.this, R.raw.dapan_c);
                                                mp_question_audio.start();
                                                mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                                    @Override
                                                    public void onCompletion(MediaPlayer mp) {
...
//                                                        mp_question_audio.start();
                                                        mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                                            ...
                                                            public void onCompletion(MediaPlayer mp) {
                                                                mp_question_audio.release();
                                                                mp_question_audio = new MediaPlayer();
                                                                mp_question_audio = MediaPlayer.create(OfflinePlayActivity.this, R.raw.dapan_d);
                                                                mp_question_audio.start();
                                                                mp_question_audio.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                                                                    @Override
                                                                    public void onCompletion(MediaPlayer mp) {
...
//                Log.d("Name Name", name + "\n" + url_out);
    ...
    public void checkWin(final int num) {
        ...
        if (num == 14) {
            ...
            mp_win = MediaPlayer.create(OfflinePlayActivity.this, R.raw.best_player);
            mp_win.start();
